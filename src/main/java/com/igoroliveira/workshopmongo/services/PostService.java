...
public class PostService {
	...
	public Post findById(String id) {
		...
		return post.orElseThrow(() -> new ObjectNotFoundException("Ojbeto Não encontrado"));
	}
	...
	public List<Post> stringSearch(String text, Date minDate, Date maxDate) {
		maxDate = new Date(maxDate.getTime() + 24 * 60 * 60 * 1000);
		return repo.searchString(text, minDate, maxDate);
	}
}
